...
export default function Home() {
  return (
    <>
      <div className="bg-blue-950 h-full text-white text-center">
        ...
        <p className="">
          ...
          where they abused her for their projects again and again. And if she
          hasn’t been rewritten, then they are still using her. Far far away,
          ...
          the skyline of her hometown Bookmarksgrove, the headline of Alphabet
          Village and the subline
        </p>
      </div>
    </>
  );
